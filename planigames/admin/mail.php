...
if ($tab === 'settings') {
  if (!pg_is_owner()) {
    ...
    echo '<div class="field"><input type="hidden" name="sig_enabled" value="0">'
       . '<label class="switch"><input type="checkbox" name="sig_enabled" value="1"' . $sigOn . '><span>Signatur anhängen</span></label>'
       . '<p class="hint">Dein Logo steht bereits oben im Mail-Kopf – die Signatur darunter bleibt bewusst ohne Logo.</p></div>';
    echo '<div class="mailgrid">';
